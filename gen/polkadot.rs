...
async fn wrapper() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let calls: ::std::vec::Vec<runtime_types::polkadot_runtime::RuntimeCall> = vec![
        ...
        { remark : vec![8, 8], __subxt_unused_type_params : ::core::marker::PhantomData
        },),
        runtime_types::polkadot_runtime::RuntimeCall::System(runtime_types::frame_system::pallet::Call::remark
        { remark : vec![8, 8], __subxt_unused_type_params : ::core::marker::PhantomData
        },)
    ...
    > = runtime_types::pallet_identity::types::BitFlags(64);
    ...
    > = runtime_types::pallet_election_provider_multi_phase::RawSolution {
        solution: runtime_types::polkadot_runtime::NposCompactSolution16 {
            votes1: vec![(32, 16), (32, 16)],
            votes2: vec![
                (32, (16, runtime_types::sp_arithmetic::per_things::PerU16(16,)), 16),
                (32, (16, runtime_types::sp_arithmetic::per_things::PerU16(16,)), 16)
            ],
            votes3: vec![
                (32, [(16, runtime_types::sp_arithmetic::per_things::PerU16(16,)), (16,
                runtime_types::sp_arithmetic::per_things::PerU16(16,))], 16), (32, [(16,
                runtime_types::sp_arithmetic::per_things::PerU16(16,)), (16,
                runtime_types::sp_arithmetic::per_things::PerU16(16,))], 16)
            ],
            votes4: vec![
                (32, [(16, runtime_types::sp_arithmetic::per_things::PerU16(16,)), (16,
    ...
    > = vec![
        ...
        (::subxt::utils::AccountId32([8; 32usize],), 128)], __subxt_unused_type_params :
        ::core::marker::PhantomData }), (::subxt::utils::AccountId32([8; 32usize],),
        runtime_types::sp_npos_elections::Support { total : 128, voters :
        vec![(::subxt::utils::AccountId32([8; 32usize],), 128),
        (::subxt::utils::AccountId32([8; 32usize],), 128)], __subxt_unused_type_params :
